...
// ** Cache is mainly used for refresh token revalidation
@Injectable()
  ...
  implements OnApplicationBootstrap, OnApplicationShutdown
{
  ...
  private toObject(value?: string | null): CacheTokenValue | null {
    try {
      ...
      // TODO simulate throw here to check global filter
    } catch (error: unknown) {
      this.logger.error(error);
      throw new InternalServerRpcException('Check cache service');
    }
  }
}
